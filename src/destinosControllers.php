...
$destinos->get('/destino1', function () use ($app) {
    return $app['twig']->render('destinos/destino.twig', array( 'iddestino' => 1 ));
})->bind('destino1');

$destinos->get('/destino2', function () use ($app) {
    return $app['twig']->render('destinos/destino.twig', array( 'iddestino' => 2 ));
})->bind('destino2');

$destinos->get('/destino3', function () use ($app) {
    return $app['twig']->render('destinos/destino.twig', array( 'iddestino' => 3 ));
})->bind('destino3');
